...
This guide walks through the process of deploying a Solidity-based smart contract to a NFTMart node using [Truffle](https://www.trufflesuite.com/), a commonly used development tool for smart contracts on Ethereum. Given NFTMart Ethereum compatibility features, Truffle can be used directly with a NFTMart node.
